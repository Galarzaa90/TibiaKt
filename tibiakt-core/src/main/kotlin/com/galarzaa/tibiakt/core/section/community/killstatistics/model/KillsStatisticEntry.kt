 ...
 * @property lastDayKilledByPlayers The number of this race killed in the last day.
 * @property lastWeekKilledPlayers The number of players killed by this race in the last week.
 * @property lastWeekKilledByPlayers The number of this race killed in the last week.
 */
@Serializable
public data class KillsStatisticEntry(
    val lastDayKilledPlayers: Int,
    val lastDayKilledByPlayers: Int,
    val lastWeekKilledPlayers: Int,
    val lastWeekKilledByPlayers: Int,
)
